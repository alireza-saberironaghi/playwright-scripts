...
const Data = {
    environments: [
        'https://keystone.sites.dev.thirdstream.ca/deposits/en/app/flow/welcome',
        'https://keystone.sites.qa.thirdstream.ca/deposits/en/app/flow/welcome',
        'https://keystone.sites.test.thirdstream.ca/deposits/en/app/flow/welcome',
        'https://keystone.sites.staging.thirdstream.ca/deposits/en/app/flow/welcome',
        'https://keystone.sites.staging.thirdstream.ca/deposits/en/app/flow/welcome',
    ],
    users: [
        {
            ...
            politicallyExposed: 'None of the above', // options: None of the above, Politically Exposed Person, Family Member of a Politically Exposed Person, Close Associate of a Politically Exposed Person
            taxResident: 'No',
            usPerson: 'No'
        },
        {
...
// Select Joint User
const selectedJointUser = getUserByName('Sherri'); // ['Helen', 'Sherri', 'Morgan', 'Francisco', 'Rhoda', 'Maximo', 'Kasey', 'Sid', 'Ambrose', 'Scot', 'Mona', 'Anne', 'Gino', 'Stan']
...
const selectSavingsPackage = Data.accountOptions.savingsPackages[0];  // ['Everyday Chequing 1', 'Everyday Chequing 2', 'RDI Savings'
...
test('Keystone_RDO', async ({ page }) => {
    ...
    await page.locator('p-radiobutton').filter({ hasText: selectOverdraft }).locator('div').nth(2).click(); // open another account

    await page.getByRole('button', { name: 'Next' }).click();

    // open another account modal
    ...
    // await page.getByLabel('Home Address').
    ...
    await page.getByLabel('Accountant', { exact: true }).click();
    ...
    if (selectAddJointApplicant === 'Yes') {
        ...
        // home address
        await page.getByRole('searchbox', { name: 'Physical address' }).type(selectedJointUser.address);
        await page.locator('//body//app-root//li[1]').click();
